...
class hadoop ($hadoop_security_authentication = "simple",
  ...
  $proxyusers = {
    oozie => { groups => 'hudson,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,yarn', hosts => "*" },
     hive => { groups => 'hudson,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,yarn', hosts => "*" },
     yarn => { groups => 'hudson,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,yarn', hosts => "*" },
   httpfs => { groups => 'hudson,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,yarn', hosts => "*" } },
